...
public class SimpleFenetreGraphique {
  ...
  /* Coin superieur gauche en position écran (50,50)  */
  ...
  /* Ordre d'effacement de la zone d'affichage        */
    cg.clear();
  /* Choix d'un rouge comme couleur de tracé          */
    cg.setColor(200,0,0);
  ...
  /* Choix d'un bleu comme couleur de tracé           */
    cg.setColor(0,0,200);
  ...
  /* Ordre d'effacement de la zone d'affichage        */
    cg2.clear();
  /* Choix du noir comme couleur de tracé             */
    cg2.setColor(0,0,0);
  /* Ordre d'affichage d'un segment de droite         */
